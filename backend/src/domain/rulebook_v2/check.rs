// use super::moves::{chess_move, pieces};
...
// ) -> Result<bool, pieces::MoveIsNotAllowed> {
//     let trial_chessboard = match pieces::apply_move_if_allowed(chess_move, chessboard_history) {
...
//         let potential_move =
//             chess_move::Move::new(opponent_piece, from_square, king_location);
//
//         // TODO. TODO. TODO.
//
