...
module.exports = {
  forbidden: [
    /** Project specific */
    {
      name: "abstract-xstate-from-components",
      comment:
        "The react components should not be aware that xstate is being used under the hood.",
...
// generated: dependency-cruiser@16.10.2 on 2025-05-30T16:39:38.651Z
